...
func init() {
	...
	_ = microcumulusv1beta1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "8caac086.microcumul.us",
	})
	if err != nil {
	...
	if err = (&controllers.OAuth2ClientProviderReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("OAuth2ClientProvider"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OAuth2ClientProvider")
		os.Exit(1)
	}
	...
	if err = (&controllers.ClusterOAuth2ClientProviderReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("ClusterOAuth2ClientProvider"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
